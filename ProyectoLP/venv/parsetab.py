...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','calc.py',45),
  ('expr -> expr MINUS expr','expr',3,'p_sub','calc.py',49),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','calc.py',53),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','calc.py',57),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','calc.py',58),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','calc.py',69),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','calc.py',73),
]
